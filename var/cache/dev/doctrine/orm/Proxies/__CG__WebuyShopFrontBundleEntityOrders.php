 ...
 */
class Orders extends \WebuyShop\FrontBundle\Entity\Orders implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'WebuyShop\\FrontBundle\\Entity\\Orders' . "\0" . 'user', '' . "\0" . 'WebuyShop\\FrontBundle\\Entity\\Orders' . "\0" . 'cart', '' . "\0" . 'WebuyShop\\FrontBundle\\Entity\\Orders' . "\0" . 'status', 'createdAt', 'updatedAt'];
        }

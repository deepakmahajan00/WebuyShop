 ...
 */
class Version20161213093329 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE cart_product CHANGE cart_id cart_id VARCHAR(255) NOT NULL, CHANGE product_id product_id VARCHAR(255) NOT NULL');
    }
